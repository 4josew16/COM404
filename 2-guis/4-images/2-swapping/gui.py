...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        # load resources
        self.cacti_before_image = PhotoImage(file="C:/Users/Wendy/Documents/GitHub/cacti_before.gif")
        self.cacti_after_image = PhotoImage(file="C:/Users/Wendy/Documents/GitHub/cacti_after.gif")
